const ButtonSvg = (white) => (
  <>
    ...
    <svg
      className="absolute left-[1.3rem] top-0 w-[calc(100%-2.625rem)]"
      height="44"
      viewBox="0 0 100 44"
      ...
      {white ? (
        ...
        <>
          <polygon
            ...
            fillRule="nonzero"
            points="120 42 100 44 0 44 0 42"
          />
          <polygon
            fill="url(#btn-bottom)" // mentioned in ButtonGradient.jsx
            fillRule="nonzero"
            points="120 0 100 2 0 2 0 0"
          />
        </>
      )}
    </svg>
    <svg
      className="absolute right-[0.05rem] top-0"
      width="21"
      height="44"
      viewBox="0 0 21 44"
    >
